...
\item[5.] there are no authors.\footnote{Although it will likely be very rare, this could occur if all the authors delete their accounts.}
\end{enumerate}
...
\item[] save
\item[] update
\item[] serialize - to JSON for transmission over HTTP.
\item[] \_delete
\end{enumerate}
