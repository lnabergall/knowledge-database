...
The following approximately documents the web client-facing main API, built using the Pyramid framework. To reduce redundancy and promote a functionality-optimal stack layout, the web API will be implemented as a thin layer on top of the client-facing Content and User APIs mainly handling request routing, templating, data serialization, and response transmission.
