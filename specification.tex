...
\item[] Recent activity: All activity on authored edits and content pieces. If there is a vote, a notification will urge the user to vote and link to the authored content pieces tab or directly to the edit depending on whether there is a single or multiple validating edits.
...
\item[] Edit history: List of authored accepted/rejected edits with the content piece name, content part, submission timestamp, acceptance/rejection timestamp, and a quantitative summary of net modifications.\footnote{e.g. number of characters/words added/removed, total formatting modifications made, and images added/removed.}
\end{enumerate}
