...
\end{itemize}
\item[] Admins and Abuse Reports
\begin{itemize}
\item All users may submit an abuse report against a piece of content. They will only be required to give a nontrivially detailed report of the alleged abuse.
\item The authors of a piece of content may also submit an abuse report against another author or group of authors. They will be required to list exactly which authors are committing the alleged abuse and give a nontrivially detailed report of the alleged abuse.
\item When an abuse report is submitted, an administrator is selected to investigate and resolve the situation. The admin may elect to take no action, send messages of guidance or warning against authors or other editing users, temporarily or permanently suspend user accounts, or revoke authorship\footnote{This may not be an exhaustive list of all possible admin actions.}. An admin may also elect to take action against a user who is determined to be abusing the abuse reporting feature.
\end{itemize}
\end{enumerate}
